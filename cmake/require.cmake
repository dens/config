...
#  $MODULE_ROOT/cmake/project.cmake
#  $MODULE_ROOT/libhello/
#  $MODULE_ROOT/libhello/CMakeLists.txt
#  $MODULE_ROOT/libhello/include/
#  $MODULE_ROOT/myprog/
...
macro (require module)
  ...
  # in PROVIDED_VARS stehen die Namen aller Variablen die an
  # provide() uebergeben wurden
...
# provide VARS...
macro (provide)
  # jede Variable bekommt eine globale Property
  foreach (v ${ARGN})
